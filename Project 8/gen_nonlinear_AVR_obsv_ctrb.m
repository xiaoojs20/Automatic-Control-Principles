function dy=gen_nonlinear_AVR_obsv_ctrb(t,y,A_obsv,B,G,K_ctrb)
...
Vf_in=K.*(U_ref+dU_ref-Vt_t-K_ctrb*y_obsv)+V_disturb;
dy1=y(2)-w0;
...
dy_obsv=A_obsv*y_obsv+B*(dU_ref-K_ctrb*y_obsv)+G*(Vt_t-workingpoint(4));
